 ...
 * font.c
 * 
 * This file contains the definition of an 8x8 pixel system font. 
 * The font is stored as an array of bytes where each character is represented
 * as an 8-row bitmap. The character set includes printable ASCII characters.
 * 
...
#include "font.h"
/*
 * Font bitmap data for an 8x8 system font. Each character is represented by 8 bytes,
 * with each byte encoding a row of the character glyph.
 */
const UINT8 font[] =
{
